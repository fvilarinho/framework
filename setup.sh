...
function createEnvironment() {
  echo "REPOSITORY_URL=$REPOSITORY_URL" > $BUILD_SECRETS_FILENAME
  echo "REPOSITORY_USERNAME=$REPOSITORY_USERNAME" >> $BUILD_SECRETS_FILENAME
  echo "REPOSITORY_PASSWORD=$REPOSITORY_PASSWORD" >> $BUILD_SECRETS_FILENAME
...
function createProjectEnvironment() {
  ...
  PROJECT_BUILD_SECRETS_FILENAME="$PROJECT_DIR/.secrets"
  ...
  if [ ! -f "$PROJECT_BUILD_SECRETS_FILENAME" ]; then
    echo "FRAMEWORK_REPOSITORY_URL=$FRAMEWORK_REPOSITORY_URL" >> $PROJECT_BUILD_SECRETS_FILENAME
    echo "FRAMEWORK_REPOSITORY_USERNAME=$FRAMEWORK_REPOSITORY_USERNAME" >> $PROJECT_BUILD_SECRETS_FILENAME
    echo "FRAMEWORK_REPOSITORY_PASSWORD=$FRAMEWORK_REPOSITORY_PASSWORD" >> $PROJECT_BUILD_SECRETS_FILENAME

    echo >> $PROJECT_BUILD_SECRETS_FILENAME
    echo "REPOSITORY_URL=$PROJECT_REPOSITORY_URL" >> $PROJECT_BUILD_SECRETS_FILENAME
    echo "REPOSITORY_USERNAME=$PROJECT_REPOSITORY_USERNAME" >> $PROJECT_BUILD_SECRETS_FILENAME
    echo "REPOSITORY_PASSWORD=$PROJECT_REPOSITORY_PASSWORD" >> $PROJECT_BUILD_SECRETS_FILENAME
