...
public enum ContentType{
	...
	public static ContentType toContentType(String contentType) throws IllegalArgumentException{
		...
		for(ContentType constant : values())
			if((constant.getMimeType() != null && constant.getMimeType().toLowerCase().equals(contentType.toLowerCase())) || 
			   (constant.getExtension() != null && contentType.toLowerCase().endsWith(constant.getExtension().toLowerCase())))
				return constant;
