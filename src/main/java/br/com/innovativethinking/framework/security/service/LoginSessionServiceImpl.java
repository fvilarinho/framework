package br.com.innovativethinking.framework.security.service;
...
import br.com.innovativethinking.framework.security.exceptions.InvalidPasswordException;
...
import br.com.innovativethinking.framework.security.exceptions.UserAlreadyLoggedInException;
import br.com.innovativethinking.framework.security.exceptions.UserBlockedException;
import br.com.innovativethinking.framework.security.exceptions.UserNotFoundException;
...
public abstract class LoginSessionServiceImpl<L extends LoginSessionModel, U extends UserModel> extends BaseService<L> implements LoginSessionService<L, U>{
	/**
	 * @see br.com.innovativethinking.framework.security.service.interfaces.LoginSessionService#updateProfile(br.com.innovativethinking.framework.security.model.UserModel)
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.security.service.interfaces.LoginSessionService#validateMfaToken(br.com.innovativethinking.framework.security.model.UserModel)
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * @see br.com.innovativethinking.framework.security.service.interfaces.LoginSessionService#logIn(br.com.innovativethinking.framework.security.model.UserModel)
	 */
	@Transaction
	@Auditable
	...
	/**
	 * @see br.com.innovativethinking.framework.security.service.interfaces.LoginSessionService#changePassword(br.com.innovativethinking.framework.security.model.UserModel)
	 */
	@SuppressWarnings("unchecked")
	@Transaction
	@Auditable
	...
	/**
	 * @see br.com.innovativethinking.framework.security.service.interfaces.LoginSessionService#logOut()
	 */
	@SuppressWarnings("unchecked")
	@Transaction
	@Auditable
	...
	/**
	 * @see br.com.innovativethinking.framework.security.service.interfaces.LoginSessionService#logOutAll()
	 */
	@SuppressWarnings("unchecked")
	@Transaction
	@Auditable
	...
	/**
	 * @see br.com.innovativethinking.framework.security.service.interfaces.LoginSessionService#sendForgottenPassword(br.com.innovativethinking.framework.security.model.UserModel)
	 */
	@SuppressWarnings("unchecked")
	@Transaction
	@Auditable
