package br.com.innovativethinking.framework.network.util;
...
public class NetworkUtil{
	...
	public static Boolean isLoopbackAddress(InetAddress address){
		return (address != null ? address.isLoopbackAddress() : false);
	}
	...
	public static Boolean isPrivateAddress(InetAddress address){
		return (address != null ? (isLoopbackAddress(address) || address.isSiteLocalAddress()) : false);
	}
