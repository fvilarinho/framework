package br.com.innovativethinking.framework.webservice;
...
import br.com.innovativethinking.framework.util.types.MethodType;
import br.com.innovativethinking.framework.webservice.constants.WebServiceConstants;
import br.com.innovativethinking.framework.webservice.resources.WebServiceResources;
import br.com.innovativethinking.framework.webservice.resources.WebServiceResourcesLoader;
		...
		try{
			...
			if(headers != null && !headers.isEmpty()){
				for(Entry<String, String> header : headers.entrySet()){
					...
					if(headerName.toLowerCase().equals(WebServiceConstants.ACCEPT_ATTRIBUTE_ID))
						accept = headerValue;
			...
			if(this.resources.getMethod() == MethodType.POST || this.resources.getMethod() == MethodType.PUT){
				GenericProcessor processor = ProcessorFactory.getInstance().
						                                      getProcessor(domain, 
						                                                   value, 
						                                                   PropertyUtil.fillPropertiesInString(value, 
						                                                                		               ExpressionProcessorUtil.fillVariablesInString(domain, 
						                                                                		            		                                         this.resources.getData(), 
						                                                                		            		                                         false, 
						                                                                		            		                                         true,
						                                                                		            		                                         language), 
						                                                                		               false, 
