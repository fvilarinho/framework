package br.com.innovativethinking.framework.model.processors;
...
import br.com.innovativethinking.framework.audit.resources.AuditorResources;
import br.com.innovativethinking.framework.audit.resources.AuditorResourcesLoader;
...
import br.com.innovativethinking.framework.processors.AnnotationProcessorFactory;
import br.com.innovativethinking.framework.processors.BaseAnnotationProcessor;
import br.com.innovativethinking.framework.processors.ExpressionProcessor;
import br.com.innovativethinking.framework.processors.ExpressionProcessorUtil;
import br.com.innovativethinking.framework.processors.GenericProcessor;
import br.com.innovativethinking.framework.processors.ProcessorFactory;
import br.com.innovativethinking.framework.processors.annotations.Tag;
import br.com.innovativethinking.framework.processors.constants.ProcessorConstants;
import br.com.innovativethinking.framework.processors.helpers.ProjectBuild;
...
import br.com.innovativethinking.framework.util.XmlReader;
import br.com.innovativethinking.framework.util.XmlWriter;
import br.com.innovativethinking.framework.util.constants.XmlConstants;
import br.com.innovativethinking.framework.util.helpers.DateTime;
import br.com.innovativethinking.framework.util.helpers.JavaIndent;
import br.com.innovativethinking.framework.util.helpers.JspIndent;
...
public class ModelAnnotationProcessor extends BaseAnnotationProcessor{
	...
	/**
	 * @see br.com.innovativethinking.framework.processors.BaseAnnotationProcessor#process()
	 */
							...
							for(Locale availableLanguage : availableLanguages){
								...
								if(!resourcesFile.exists()){
									if((this.modelInfo.generateWebService() != null && this.modelInfo.generateWebService()) ||
									   (this.modelInfo.generateService() != null && this.modelInfo.generateService()) || 
									   (this.modelInfo.generateUi() != null && this.modelInfo.generateUi()) || 
									   (this.modelInfo.generateActionsAndForm() != null && this.modelInfo.generateActionsAndForm())){
										ExpressionProcessorUtil.setVariable(Constants.PACKAGE_PREFIX_ATTRIBUTE_ID, packagePrefix);
										ExpressionProcessorUtil.setVariable(Constants.PACKAGE_SUFFIX_ATTRIBUTE_ID, packageSuffix);
										ExpressionProcessorUtil.setVariable(Constants.PACKAGE_NAME_ATTRIBUTE_ID, packageName);
										ExpressionProcessorUtil.setVariable(Constants.NAME_ATTRIBUTE_ID, name);
