...
public class EvaluateProcessor extends GenericProcessor{
	...
	/**
	 * @see br.com.innovativethinking.framework.processors.GenericProcessor#returnContent()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.processors.GenericProcessor#hasLogic()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.processors.GenericProcessor#process()
	 */
