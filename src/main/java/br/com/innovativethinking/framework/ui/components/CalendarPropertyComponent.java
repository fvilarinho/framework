...
public class CalendarPropertyComponent extends TextPropertyComponent{
	...
	private class HoursPropertyComponent extends SliderBarComponent{
		...
		/**
		 * @see br.com.innovativethinking.framework.ui.components.SliderBarComponent#buildEvents()
		 */
		protected void buildEvents() throws InternalErrorException{
		...
		/**
		 * @see br.com.innovativethinking.framework.ui.components.SliderBarComponent#initialize()
		 */
		protected void initialize() throws InternalErrorException{
			super.initialize();
