package br.com.innovativethinking.framework.ui.controller;
...
import br.com.innovativethinking.framework.ui.components.ActionFormComponent;
...
public class UIController{
	...
	public ActionFormComponent getActionFormComponentInstance(String actionFormName){
		if(actionFormName != null && actionFormName.length() > 0){
			...
			return (ActionFormComponent)this.systemController.getAttribute(key.toString(), ScopeType.REQUEST);
		}
