...
import br.com.innovativethinking.framework.ui.components.types.PagerActionType;
...
public class GridPropertyComponent extends OptionsPropertyComponent{
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.BaseActionFormComponent#buildName()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.OptionsPropertyComponent#buildRestrictions()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.BaseOptionsPropertyComponent#initialize()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.BaseOptionsPropertyComponent#renderDatasetIndexesAttributes()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.BaseComponent#renderId()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.BasePropertyComponent#renderEvents()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.BaseOptionsPropertyComponent#renderNoDatasetMessage()
	 */
									...
									if(columnComponent.showAsImage() == null || !columnComponent.showAsImage()){
										if((columnEditable != null && columnEditable) || columnIsBoolean){
											if(columnIsDate){
												...
												((CalendarPropertyComponent)columnPropertyComponent).setPattern(columnPattern);
												((CalendarPropertyComponent)columnPropertyComponent).setIsTime(columnIsTime);
											}
