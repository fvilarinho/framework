...
import br.com.innovativethinking.framework.controller.form.util.ActionFormMessageUtil;
...
public class MessageBoxComponent extends DialogBoxComponent{
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.DialogBoxComponent#buildResources()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.DialogBoxComponent#buildTitle()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.BaseActionFormComponent#buildPermissions()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.DialogBoxComponent#renderBody()
	 */
	protected void renderBody() throws InternalErrorException{
		...
		if(name != null && name.length() > 0){
			...
			if(this.type != null && this.type.length() > 0){
				...
				print("\" width=\"1\">");
				print("<div class=\"");
				print(this.type.toString().toLowerCase());
