...
import br.com.innovativethinking.framework.util.MethodUtil;
import br.com.innovativethinking.framework.util.PropertyUtil;
import br.com.innovativethinking.framework.util.StringUtil;
import br.com.innovativethinking.framework.util.helpers.Node;
...
public class TreeViewPropertyComponent extends OptionsPropertyComponent{
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.OptionsPropertyComponent#getOptionLabelIndentation(java.lang.Integer)
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.OptionsPropertyComponent#buildAlignment()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.BasePropertyComponent#renderLabelAttribute()
	 */
	protected void renderLabelAttribute() throws InternalErrorException{
	}

	/**
	 * @see br.com.innovativethinking.framework.ui.components.BasePropertyComponent#renderPatternAttribute()
	 */
				...
				if((parent == null && node.getParent() == null) || (parent != null && parent.equals(node.getParent()))){
					...
					if((node.hasChildren() == null || !node.hasChildren()) && (this.onExpand == null || this.onExpand.length() == 0)){
						...
						if(nodeIsExpandedBuffer == null || nodeIsExpandedBuffer.length() == 0){
							if(this.expandLevel != null && level != null && this.expandLevel <= level)
