...
public class ConfirmDialogBoxComponent extends MessageBoxComponent{
	...
	protected void buildEvents() throws InternalErrorException{
		...
		if(this.onConfirm != null && this.onConfirm.length() > 0){
			confirmContent.append(" ");
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.DialogBoxComponent#renderControls()
	 */
	...
	/**
	 * @see br.com.innovativethinking.framework.ui.components.MessageBoxComponent#clearAttributes()
	 */
