package br.com.innovativethinking.framework.mq;
...
import br.com.innovativethinking.framework.mq.helpers.MqListener;
import br.com.innovativethinking.framework.mq.helpers.MqMessage;
import br.com.innovativethinking.framework.mq.resources.MqResources;
import br.com.innovativethinking.framework.mq.resources.MqResourcesLoader;
...
public class Mq{
	...
	public <M extends MqMessage> M pull(String queueId, Boolean wait) throws InternalErrorException{
		try{
			...
			if(m != null){
				Class<?> clazz = (Class<?>)Class.forName(m.getStringProperty(Constants.CLASS_ATTRIBUTE_ID));
