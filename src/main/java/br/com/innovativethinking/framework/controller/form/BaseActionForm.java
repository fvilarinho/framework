package br.com.innovativethinking.framework.controller.form;
...
import br.com.innovativethinking.framework.controller.form.util.ActionFormPopulator;
import br.com.innovativethinking.framework.controller.form.util.ActionFormUtil;
import br.com.innovativethinking.framework.controller.form.util.ActionFormValidator;
	...
	public void processRequest(SystemController systemController, ActionFormController actionFormController, SecurityController securityController) throws Throwable{
		...
		try{
			...
			if(actionFormValidatorClass != null){
				actionFormValidator = (ActionFormValidator)ConstructorUtils.invokeConstructor(actionFormValidatorClass, new Object[]{this, systemController, actionFormController, securityController});
